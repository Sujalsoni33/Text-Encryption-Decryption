...
from tkinter import *
import StartScreen
import Hybrid.HybridEncryptScreen as HybridEncryptScreen
import Hybrid.HybridDecryptScreen as HybridDecryptScreen
...
def EncryptDecrypt(root):
    ...
    def encrypt_key():
        start_frame.destroy()
        HybridEncryptScreen.encrypt_screen(root)

    def decipher_key():
        start_frame.destroy()
        HybridDecryptScreen.decipher_screen(root)
